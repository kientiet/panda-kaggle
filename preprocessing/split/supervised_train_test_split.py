...
import pandas as pd
import numpy as np
from preprocessing.dataset.load_supervised_dataset import SupervisedDataset
...
def load_train_data(train_table, transform, data_dir, loss_type):
...
def load_dataframe(transform, data_dir, loss_type, table = None):
  ...
  trainset = load_train_data(train, transform[0], data_dir, loss_type)
